  ...
  <div id="card">
    <div id="card-content">
      ...
      <form action="" method="POST">
        ...
        <p class="text-center" style="color: blue;">Belum punya akun? <a style="font-style: italic;" href="registrasi.php">Registrasi</a> terlebih dahulu! </p>
        <p class="text-center" style="color: blue;"><a href="lupapassword.php">Lupa Password</a></p>
      </form>
    </div>
  </div>
